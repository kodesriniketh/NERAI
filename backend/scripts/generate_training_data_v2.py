...
MINOR_CITIES = {
    ...
    "Dawki": (25.1843, 92.0163),
    "Nongpoh": (25.9038, 91.8814),
    "Jowai": (25.4468, 92.2036),
    "Tura": (25.5146, 90.2031),
    "Williamnagar": (25.4851, 90.6214),
    "Baghmara": (25.1950, 90.6272),
    "Resubelpara": (25.8943, 90.6033),
    "Mairang": (25.5604, 91.6366),
    "Nongstoin": (25.5222, 91.2676),
    "Amlarem": (25.2015, 92.0463),
    "Mawkyrwat": (25.3184, 91.4429),
    "Khliehriat": (25.3619, 92.3687),
    "Ampati": (25.4674, 89.9287),
    "Dadenggre": (25.7196, 90.1878),
    "Chokpot": (25.3108, 90.4907),
    "Selsella": (25.7360, 90.0456),
    "Rongram": (25.5786, 90.2520),
    "Betasing": (25.4616, 89.9463)
}
...
def generate_training_data():
    ...
    # Pick 400 random combinations to respect OSRM rate limits & time
    target_pairs = all_pairs[:400]
                ...
                if data.get('code') == 'Ok' and data.get('routes'):
                    ...
                    for (lon, lat) in sampled_coords:
                        ...
                        risk_score = (
                            ...
                            (max(0, 1000 - dist_to_river_m) / 1000) * 0.15 + # High risk if within 1km of river
                            (1.0 - veg_cover) * 0.05 +
                            soil_moisture * 0.05 + 
